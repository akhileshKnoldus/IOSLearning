...
class ViewController: UIViewController  , CLLocationManagerDelegate{
    ...
    override func viewDidLoad() {
       ...
       // mapKitView.setRegion(rkgitAnnoation.region, animated: true)
...
//        if let schoolAnotation = mapView.dequeueReusableAnnotationView(withIdentifier: MKMapViewDefaultAnnotationViewReuseIdentifier) as? MKMarkerAnnotationView {
//
//            schoolAnotation.animatesWhenAdded = true
//            schoolAnotation.titleVisibility = .adaptive
//            return schoolAnotation
//         }
//        return nil
//    }
//    func displayMyAlertMsg(userMessage:String){
//        let myAlert = UIAlertController(title: "Location", message: userMessage, preferredStyle: UIAlertControllerStyle.alert)
